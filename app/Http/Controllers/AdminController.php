...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("admin.dashbord.index", compact('total_hotdeals', 'total_specialoffer', 'total_testinonials', 'totalsellers', 'latestorders', 'filterpayout', 'products', 'order', 'user', 'store', 'coupan', 'category', 'totalcancelorder', 'faqs', 'inv_cus', 'userchart', 'piechart', 'orderchart', 'storerequest','registerTodayUsers','totalproducts'));
    }
